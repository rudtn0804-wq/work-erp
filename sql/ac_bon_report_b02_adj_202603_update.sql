...
--          (ADJ0002 잔액손상: A01=기초금액, A02=기준잔액, A03=당기증감)
-- ADJ_CODE: ADJ0001 신규실행금액 / ADJ0002 잔액손상 / ADJ0003 개발소비세매각
--           ADJ0004 운용행탈수수료매각 / ADJ0005 품별차이대체
--           ADJ0006 감가상각(Automobile) / ADJ0007 감가상각(ICT) / ADJ0008 처분손익
--
-- ※ SITE_CODE = 'AA100001' (그리드 확인). ADJ_CODE = ADJ0001~ADJ0008.
-- ※ SEQ 는 화면 표시 순서(001,002,...) 기준으로 매핑함. 실제 SEQ 와 대조 후 실행.
-- ※ 그리드상 ADJ0001 은 SEQ 007까지(Auto), ADJ0003 은 SEQ 004까지 존재.
--    본 스크립트는 리포트에서 판독된 행만 갱신(ADJ0001:001~006, ADJ0003:001~003).
--    남는 행(ADJ0001/007, ADJ0003/004 등)은 원본 확인 후 추가할 것.
-- ※ 실행 전 대상 확인:
--      SELECT * FROM AC_BON_REPORT_B02_ADJ WHERE K1_YYYYMM='202603' ORDER BY ADJ_CODE, SEQ;
--------------------------------------------------------------------------------

DEFINE site = 'AA100001'      -- TODO: 운영 SITE_CODE 확인
DEFINE ym   = '202603'

--==============================================================================
-- [ADJ0001] 당기 신규실행 금액   (A01=1Q, A02=2Q, A03=3Q, A04=4Q, A05=당기합계)
--==============================================================================
...
UPDATE AC_BON_REPORT_B02_ADJ SET
 ...
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0001' AND SEQ='001';

-- 002  렌탈 / Automobile
UPDATE AC_BON_REPORT_B02_ADJ SET
   B02_A01 = 65000000000, B02_A02 = 70000000000, B02_A03 = 72500000000,
   B02_A04 = 75000000000, B02_A05 = 282500000000, UPDATE_DATE = SYSDATE
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0001' AND SEQ='002';
...
UPDATE AC_BON_REPORT_B02_ADJ SET
 ...
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0001' AND SEQ='003';
...
UPDATE AC_BON_REPORT_B02_ADJ SET
 ...
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0001' AND SEQ='004';
...
UPDATE AC_BON_REPORT_B02_ADJ SET
 ...
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0001' AND SEQ='005';
...
UPDATE AC_BON_REPORT_B02_ADJ SET
 ...
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0001' AND SEQ='006';


--==============================================================================
-- [ADJ0002] 잔액손상 조정   (A01=기초금액, A02=기준잔액, A03=당기증감)
--==============================================================================
...
UPDATE AC_BON_REPORT_B02_ADJ SET
   ...
   UPDATE_DATE = SYSDATE
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0002' AND SEQ='001';

-- 002  렌탈 / Automobile
UPDATE AC_BON_REPORT_B02_ADJ SET
   B02_A01 = 544978851, B02_A02 = 1041107181, B02_A03 = -496128630,
   UPDATE_DATE = SYSDATE
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0002' AND SEQ='002';

-- 003  ICT / Measuring and Information-Related Equipment
UPDATE AC_BON_REPORT_B02_ADJ SET
   B02_A01 = 420237092, B02_A02 = 488891426, B02_A03 = -68654334,
   UPDATE_DATE = SYSDATE
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0002' AND SEQ='003';


--==============================================================================
-- [ADJ0003] 당기 개발소비세 매각금액   (A01~A04=1Q~4Q, A05=당기합계)
--==============================================================================
...
UPDATE AC_BON_REPORT_B02_ADJ SET
 ...
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0003' AND SEQ='001';
...
UPDATE AC_BON_REPORT_B02_ADJ SET
 ...
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0003' AND SEQ='002';

-- 003  장부가액 / Automobile
UPDATE AC_BON_REPORT_B02_ADJ SET
   B02_A01 = 47552427, B02_A02 = 153181006, B02_A03 = 219023786,
   B02_A04 = 254277400, B02_A05 = 674034619, UPDATE_DATE = SYSDATE
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0003' AND SEQ='003';


--==============================================================================
-- [ADJ0004] 당기 운용행탈수수료 매각금액   (4Q 및 당기합계에만 값)
--==============================================================================
...
UPDATE AC_BON_REPORT_B02_ADJ SET
 ...
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0004' AND SEQ='001';

-- 002  전기상각누계액 / Automobile
UPDATE AC_BON_REPORT_B02_ADJ SET
   B02_A01 = 0, B02_A02 = 0, B02_A03 = 0,
   B02_A04 = 18160851023, B02_A05 = 18160851023, UPDATE_DATE = SYSDATE
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0004' AND SEQ='002';

-- 003  장부가액 / Automobile
UPDATE AC_BON_REPORT_B02_ADJ SET
   B02_A01 = 0, B02_A02 = 0, B02_A03 = 0, B02_A04 = 0, B02_A05 = 0,
   UPDATE_DATE = SYSDATE
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0004' AND SEQ='003';

-- 004  취득원가 / Measuring and Information-Related Equipment
UPDATE AC_BON_REPORT_B02_ADJ SET
   B02_A01 = 0, B02_A02 = 0, B02_A03 = 0, B02_A04 = 0, B02_A05 = 0,
   UPDATE_DATE = SYSDATE
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0004' AND SEQ='004';

-- 005  전기상각누계액 / Measuring and Information-Related Equipment
UPDATE AC_BON_REPORT_B02_ADJ SET
   B02_A01 = 0, B02_A02 = 0, B02_A03 = 0, B02_A04 = 0, B02_A05 = 0,
   UPDATE_DATE = SYSDATE
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0004' AND SEQ='005';

-- 006  장부가액 / Measuring and Information-Related Equipment
UPDATE AC_BON_REPORT_B02_ADJ SET
   B02_A01 = 0, B02_A02 = 0, B02_A03 = 0, B02_A04 = 0, B02_A05 = 0,
   UPDATE_DATE = SYSDATE
 WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0004' AND SEQ='006';


--==============================================================================
-- [ADJ0005] 당기 운용행자산-품별차이 대체   (A01=1Q, A02=2Q, A05=당기합계)
--==============================================================================
...
--  WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0006' AND SEQ='001';

-- ADJ0006 002  운용리스(감가상각비) / Automobile  [추정-검증요]
-- UPDATE AC_BON_REPORT_B02_ADJ SET
--    B02_A01 = 23189149016, B02_A02 = 46564526465, B02_A03 = 70401144754,
--    B02_A04 = 95373713149, B02_A05 = 95373713149, UPDATE_DATE = SYSDATE
--  WHERE SITE_CODE='&site' AND K1_YYYYMM='&ym' AND ADJ_CODE='ADJ0006' AND SEQ='002';
